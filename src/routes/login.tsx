...
export default function Login() {
  ...
  const handleSubmit = (e: { preventDefault: () => void; }) => {
    ...
    setTimeout(() => {
      ...
      // Di sini Anda biasanya akan memanggil API untuk otentikasi
    }, 1500);
  };
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-purple-50 via-purple-100 to-purple-200 p-4 font-sans text-slate-800">
      ...
      {/* Container Card */}
      <div className="max-w-md w-full bg-white/90 backdrop-blur-sm rounded-3xl shadow-xl overflow-hidden border border-purple-100/50">
